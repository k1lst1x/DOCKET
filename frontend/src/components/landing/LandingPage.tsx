...
// The landing page at /. The app itself (the neighborhood feed) is at /app.
        ...
        <main id="main">
          ...
          <section aria-labelledby="about-title" className="page pt-6 text-center sm:pt-12">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link href="/app#address" className="btn btn-primary rounded-full">
                Find your group
              </Link>
              <Link href="/app" className="btn btn-secondary rounded-full border-ink/30 bg-white/70">
          ...
          <section aria-labelledby="cta-title" className={`${styles.night} text-snow`}>
            <div className={`page pt-16 text-center sm:pt-24 ${styles.reveal}`}>
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <Link href="/app#address" className="on-dark btn rounded-full bg-snow text-coal hover:bg-[#DDEBF6]">
                  Find your group
                </Link>
